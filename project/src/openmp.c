...
void printAvgToFile() {
	fptr = fopen("/home/b/Documents/parallel/project/src/openmp_avg.csv","a");
...
void printFileHeader() {
	fptr = fopen("/home/b/Documents/parallel/project/src/openmp_avg.txt","a");
	fprintf(fptr,"f#,mspf,openmp\n");
	fclose(fptr);
}
